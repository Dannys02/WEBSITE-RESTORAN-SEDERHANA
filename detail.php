...
<body class="bg-slate-50">
  <div class="max-w-4xl mx-auto p-6 md:p-12">
    ...
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden flex flex-col md:flex-row border border-slate-200">
      ...
      <div class="md:w-1/2 p-8">
        ...
        <div class="bg-slate-100 p-2 rounded mb-4 inline-block text-sm">
        ...
        <button id="pesan" onclick="Pesan()" class="w-full bg-blue-600 text-white py-3 rounded-xl font-bold hover:bg-blue-700 shadow-lg">
          Pesan Sekarang
        </button>
      </div>
    </div>
  ...
  <script>
    function Pesan() {
      alert('Silahkan pesan melalui katalog depan untuk saat ini.');
