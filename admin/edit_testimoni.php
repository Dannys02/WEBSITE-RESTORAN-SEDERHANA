...
<div class="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-md border border-slate-200">
  ...
  <form action="" method="POST" class="space-y-4">
    ...
    <div>
      ...
      class="w-full border border-slate-200 p-3 rounded-lg shadow-sm focus:ring-2 focus:ring-orange-500 outline-none transition" required>
    </div>
    ...
    <div>
      ...
      <textarea name="isi" rows="5"
        class="w-full border border-slate-200 p-3 rounded-lg shadow-sm focus:ring-2 focus:ring-orange-500 outline-none transition" required><?= htmlspecialchars($t['isi']) ?></textarea>
    </div>
