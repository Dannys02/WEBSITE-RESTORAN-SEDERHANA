  ...
  <div class="max-w-6xl mx-auto">
    <div class="flex justify-between items-center mb-6">
      ...
      <div class="flex gap-4">
        <a href="orders.php" class="bg-gray-500 text-white px-4 py-2 rounded">Lihat Pesanan</a>
        <a href="crud_produk.php" class="bg-blue-600 text-white px-4 py-2 rounded font-bold">+ Tambah Produk</a>
      </div>
    </div>
        ...
        <tbody class="divide-y">
          ...
          <tr>
            ...
            <td class="p-4 text-center">
              <a href="edit_produk.php?id=<?= $row['id'] ?>" class="text-blue-600 hover:underline mr-3">Edit</a>
